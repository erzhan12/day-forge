...
class TestConnectRateLimit(ConnectRateLimitContract):
    ...
    SLUG = "habitica"
    SETTINGS_ATTR = "HABITICA_CONNECT_RATE_LIMIT_PER_HOUR"
    MOCK_TARGET = "habitica_sync.service.verify_credentials"
    AUTH_ERROR = service.HabiticaAuthError
    valid_body = {"api_user_id": "habitica-user", "api_token": "valid-token"}
    oversized_body = {"api_user_id": "habitica-user", "api_token": "x" * 200_000}
    EXPECTED_VERIFY_ARGS = ("habitica-user", "valid-token")
